...
import org.eclipse.epf.diagram.ad.edit.policies.InitialNodeCanonicalEditPolicy;
import org.eclipse.epf.diagram.ad.edit.policies.InitialNodeGraphicalNodeEditPolicy;
...
public class InitialNodeEditPart extends AbstractBorderedShapeEditPart implements InternalNodeEditPart {
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof InitialNodeNameEditPart) {
	...
	protected NodeFigure createNodePlate() {
		return new DefaultSizeNodeFigure(getMapMode().DPtoLP(20), getMapMode()
				.DPtoLP(20));
	}
	...
	public class InitialNodeFigure extends Ellipse {
		...
		public InitialNodeFigure() {
			...
			this.setPreferredSize(getMapMode().DPtoLP(20), getMapMode().DPtoLP(
					20));
	 ...
	 * @generated
	 */
	public static final Color INITIALNODEFIGURE_BACK = new Color(null, 45, 85,
			130);

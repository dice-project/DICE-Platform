 ...
 * @generated
 */
public class WorkProductDescriptorNodeNameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public WorkProductDescriptorNodeNameEditPart(View view) {
		super(view);
	}
			...
			ParserHintAdapter hintAdapter = new ParserHintAdapter(
				...
				public Object getAdapter(Class adapter) {
					if (IElementType.class.equals(adapter)) {
						return DiagramElementTypes.WorkProductDescriptorNode_2003;
					}

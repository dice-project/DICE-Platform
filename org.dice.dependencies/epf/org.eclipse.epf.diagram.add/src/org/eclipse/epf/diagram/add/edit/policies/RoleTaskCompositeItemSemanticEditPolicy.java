 ...
 * @generated
 */
public class RoleTaskCompositeItemSemanticEditPolicy extends
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (DiagramElementTypes.RoleNode_2001 == req.getElementType()) {
			if (req.getContainmentFeature() == null) {
				req.setContainmentFeature(ModelPackage.eINSTANCE
						.getNodeContainer_Nodes());
			}
			return getMSLWrapper(new RoleNodeCreateCommand(req));
		}
		if (DiagramElementTypes.TaskNode_2002 == req.getElementType()) {
			if (req.getContainmentFeature() == null) {
				req.setContainmentFeature(ModelPackage.eINSTANCE
						.getNodeContainer_Nodes());
			}
			return getMSLWrapper(new TaskNodeCreateCommand(req));
		}

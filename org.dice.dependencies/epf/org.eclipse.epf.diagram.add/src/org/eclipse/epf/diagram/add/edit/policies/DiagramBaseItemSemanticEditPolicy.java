...
import org.eclipse.epf.diagram.add.edit.helpers.DiagramBaseEditHelper;
 ...
 * @generated
 */
public class DiagramBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	public Command getCommand(Request request) {
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(DiagramVisualIDRegistry
	...
	protected Command getSemanticCommand(IEditCommandRequest request) {
		...
		if (epCommand != null) {
			...
			completedRequest.setParameter(
					DiagramBaseEditHelper.EDIT_POLICY_COMMAND, command);
		}
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		public static boolean canCreateLink_3001(Node container, Node source,
				Node target) {
			return canExistLink_3001(container, source, target);
		}

		/**
		 * @generated
		 */
		public static boolean canExistLink_3001(Node container, Node source,
				Node target) {
			return true;
		}

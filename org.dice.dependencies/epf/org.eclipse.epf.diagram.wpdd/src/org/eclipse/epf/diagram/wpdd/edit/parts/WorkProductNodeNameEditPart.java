...
import org.eclipse.epf.diagram.wpdd.edit.policies.DiagramTextSelectionEditPolicy;
 ...
 * @generated
 */
public class WorkProductNodeNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public WorkProductNodeNameEditPart(View view) {
		super(view);
	}
	...
	protected Image getLabelIcon() {
		//		ImageDescriptor descriptor = WPDDiagramEditorPlugin.getInstance()
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof DiagramTextSelectionEditPolicy) {
			((DiagramTextSelectionEditPolicy) pdEditPolicy).refreshFeedback();
		}
	}
			...
			ParserHintAdapter hintAdapter = new ParserHintAdapter(
				...
				public Object getAdapter(Class adapter) {
					if (IElementType.class.equals(adapter)) {
						return DiagramElementTypes.WorkProductNode_1001;
					}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new ValidatingTextDirectEditManager(this,
					ValidatingTextDirectEditManager
							.getTextCellEditorClass(this), DiagramEditPartFactory
				...
				protected String validate(String txt) {
					...
					if (obj instanceof Node) {
						Node model = (Node) obj;
						EObject umaNode = model.getElement();
						
						if (umaNode instanceof WorkProductNode) {
							org.eclipse.epf.diagram.model.Node node = (org.eclipse.epf.diagram.model.Node) umaNode;
				...
				protected void performDirectEdit() {
					((WorkProductNodeNameEditPart) getEditPart())
							.performDirectEdit();
				}
	...
	protected void refreshFont() {
		FontStyle style = (FontStyle) getFontStyleOwnerView().getStyle(
				NotationPackage.eINSTANCE.getFontStyle());
		if (style != null) {
			String fontName = DiagramConstants.getFontName(style);
			FontData fontData = new FontData(fontName, style

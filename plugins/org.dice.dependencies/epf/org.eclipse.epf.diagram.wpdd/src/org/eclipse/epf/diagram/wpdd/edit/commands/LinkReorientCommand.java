...
public class LinkReorientCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		if (!(getElementToEdit() instanceof Link)) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return DiagramBaseItemSemanticEditPolicy.LinkConstraints
				.canExistLink_3001(container, getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Node container = (Node) getLink().eContainer();
		return DiagramBaseItemSemanticEditPolicy.LinkConstraints
				.canExistLink_3001(container, source, getNewTarget());
	}

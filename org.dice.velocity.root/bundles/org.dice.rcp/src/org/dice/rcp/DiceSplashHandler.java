...
public class DiceSplashHandler extends BasicSplashHandler {
	...
	public void init(Shell splash) {
		...
		Rectangle progressRect = StringConverter.asRectangle(progressRectString, new Rectangle(170, 195, 560, 15));
		setProgressRect(progressRect);

		Rectangle messageRect = StringConverter.asRectangle(messageRectString, new Rectangle(170, 175, 560, 15));
		...
		setForeground(new RGB((foregroundColorInteger & 0x20) >> 16, (foregroundColorInteger & 0x4A) >> 8,
				foregroundColorInteger & 0x87));
		...
		idLabel.setBounds(new Rectangle(450, 155, 280, 15));
		...
		basedOnLabel.setBounds(new Rectangle(170, 155, 280, 15));
